...
def score_docking_site(antigen_seq: str, ab_seq: str, site_idx: int) -> float:
    """
    Inner Grover oracle: Score specific docking position i
    TODO: Replace with real physics (electrostatics at position i)
    """
    L = min(len(antigen_seq), len(ab_seq))
    if site_idx >= L:
        return 0.0
    
    # Simple: complementarity at position i + neighbors
    score = 1.0 if antigen_seq[site_idx] in ['D','E'] and ab_seq[site_idx] in ['K','R'] else 0.5
